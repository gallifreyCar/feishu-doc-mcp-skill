---
description: Use when working with Feishu/Lark cloud documents - reading, creating, updating, or debugging permission issues
globs:
alwaysApply: false
---
...
This rule enables Cursor to work with Feishu/Lark cloud documents through Feishu's remote MCP service.
...
Use the bundled client at `scripts/feishu_mcp_doc.py`:
